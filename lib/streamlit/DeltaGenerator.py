...
class DeltaGenerator(object):
    ...
    def slider(
        ...
        element, floats_value, is_range, orig_tz = slider.marshall_proto(
            element, label, min_value, max_value, value, step, format
        )
        # print("-------", floats_value)

        # Get the value(s) that are currently set in the slider widget
        ui_value = _get_widget_ui_value("slider", element, user_key=key)
        # print("**********", ui_value, element)
        current_value = ui_value.value if ui_value else floats_value
